...
} from "./chunk-IKDW6RZR.js";
import {
  require_jsx_runtime
} from "./chunk-HSESELKR.js";
import "./chunk-2UUIUWVK.js";
import {
  Global,
  _extends,
  keyframes,
  require_react_is
} from "./chunk-LESLK4YJ.js";
import {
  AnimatePresence,
  motion,
  useIsPresent,
  usePresence
} from "./chunk-X2PLXAGS.js";
import {
  __commonJS,
  __toESM,
  require_react
...
function useDescendants() {
  const descendants = (0, import_react11.useRef)(new DescendantsManager());
...
function useDescendant(options) {
  ...
  const [index, setIndex] = (0, import_react11.useState)(-1);
...
function useAccordionItem(props) {
  ...
  const getButtonProps = (0, import_react13.useCallback)(
  ...
  const getPanelProps = (0, import_react13.useCallback)(
...
var Collapse = (0, import_react15.forwardRef)(
  (props, ref) => {
    const {
      in: isOpen,
      unmountOnExit,
...
var Fade = (0, import_react16.forwardRef)(function Fade2(props, ref) {
  const {
    unmountOnExit,
    in: isOpen,
    className,
...
var ScaleFade = (0, import_react17.forwardRef)(
...
var SlideFade = (0, import_react18.forwardRef)(
...
var Slide = (0, import_react19.forwardRef)(function Slide2(props, ref) {
  const {
    direction = "right",
    style,
    unmountOnExit,
...
function AvatarImage(props) {
  ...
  if (showFallback) {
    ...
    ) : (0, import_react22.cloneElement)(icon, {
      role: "img",
...
var AvatarGroup = forwardRef(
  function AvatarGroup2(props, ref) {
    ...
    const clones = reversedChildren.map((child, index) => {
      ...
      return (0, import_react25.cloneElement)(child, compact2(childProps));
    });
    const groupStyles = {
      display: "flex",
      alignItems: "center",
...
var Breadcrumb = forwardRef(
  function Breadcrumb2(props, ref) {
    ...
    const clones = validChildren.map(
      (child, index) => (0, import_react27.cloneElement)(child, {
        separator,
        spacing,
...
function useButtonType(value) {
  const [isButton, setIsButton] = (0, import_react29.useState)(!value);
  const refCallback = (0, import_react29.useCallback)((node2) => {
    if (!node2)
      return;
...
var Button = forwardRef((props, ref) => {
  ...
  const buttonStyles = (0, import_react32.useMemo)(() => {
...
var IconButton = forwardRef(
  (props, ref) => {
    ...
    const _children = (0, import_react33.isValidElement)(element) ? (0, import_react33.cloneElement)(element, {
      "aria-hidden": true,
      focusable: false
    }) : null;
...
function useCheckboxGroup(props = {}) {
  ...
  const getCheckboxProps = (0, import_react34.useCallback)(
    (props2 = {}) => {
...
function CheckboxGroup(props) {
  ...
  const group = (0, import_react35.useMemo)(
    () => ({
      size,
      onChange,
      colorScheme,
...
function useInitialAnimationState(isChecked) {
  const [previousIsChecked, setPreviousIsChecked] = (0, import_react36.useState)(isChecked);
  const [shouldAnimate, setShouldAnimate] = (0, import_react36.useState)(false);
...
var Checkbox = forwardRef(function Checkbox2(props, ref) {
  ...
  const iconStyles = (0, import_react38.useMemo)(
    () => ({
  ...
  const clonedIcon = (0, import_react38.cloneElement)(icon, {
    __css: iconStyles,
...
function useCounter(props = {}) {
  ...
  const onChangeProp = useCallbackRef(onChange);
  const [valueState, setValue] = (0, import_react39.useState)(() => {
    var _a2;
  ...
  const clamp = (0, import_react39.useCallback)(
    (value2) => {
  ...
  const increment = (0, import_react39.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse(step);
  ...
  const decrement = (0, import_react39.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse(-step);
  ...
  const castValue = (0, import_react39.useCallback)(
    (value2) => {
      var _a2;
...
function useEditable(props = {}) {
  ...
  const [isEditing, setIsEditing] = (0, import_react41.useState)(defaultIsEditing);
  const [value, setValue] = useControllableState({
    defaultValue: defaultValue || "",
    value: valueProp,
    onChange: onChangeProp
  });
  const [prevValue, setPrevValue] = (0, import_react41.useState)(value);
  const inputRef = (0, import_react41.useRef)(null);
  const previewRef = (0, import_react41.useRef)(null);
  const editButtonRef = (0, import_react41.useRef)(null);
  const cancelButtonRef = (0, import_react41.useRef)(null);
  const submitButtonRef = (0, import_react41.useRef)(null);
  ...
  const onEdit = (0, import_react41.useCallback)(() => {
    if (isInteractive) {
      setIsEditing(true);
    }
  }, [isInteractive]);
  const onUpdatePrevValue = (0, import_react41.useCallback)(() => {
    setPrevValue(value);
  }, [value]);
  ...
  const onSubmit = (0, import_react41.useCallback)(() => {
    setIsEditing(false);
    setPrevValue(value);
  ...
  const onKeyDownWithoutSubmit = (0, import_react41.useCallback)(
    (event) => {
      const eventKey = event.key;
      const keyMap = {
        Escape: onCancel
  ...
  const onBlur3 = (0, import_react41.useCallback)(
    (event) => {
      var _a2;
      if (!isEditing)
        return;
  ...
  const getPreviewProps = (0, import_react41.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getTextareaProps = (0, import_react41.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      hidden: !isEditing,
      placeholder,
  ...
  const getEditButtonProps = (0, import_react41.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Edit",
      ...props2,
      type: "button",
  ...
  const getSubmitButtonProps = (0, import_react41.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      "aria-label": "Submit",
  ...
  const getCancelButtonProps = (0, import_react41.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Cancel",
      id: "cancel",
      ...props2,
...
var InFocusGuard = function InFocusGuard2(_ref2) {
  ...
  return import_react43.default.createElement(import_react43.Fragment, null, import_react43.default.createElement("div", {
    key: "guard-first",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
  }), children, children && import_react43.default.createElement("div", {
    key: "guard-last",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
...
var focusScope = (0, import_react46.createContext)(void 0);

// node_modules/react-focus-lock/dist/es2015/Lock.js
var emptyArray = [];
var FocusLock = (0, import_react47.forwardRef)(function FocusLockUI(props, parentRef) {
  var _extends2;
  var _useState = (0, import_react47.useState)(), realObserved = _useState[0], setObserved = _useState[1];
  var observed = (0, import_react47.useRef)();
  var isActive = (0, import_react47.useRef)(false);
  var originalFocusedElement = (0, import_react47.useRef)(null);
  var _useState2 = (0, import_react47.useState)({}), update = _useState2[1];
  ...
  var _useState3 = (0, import_react47.useState)({}), id = _useState3[0];
  var onActivation = (0, import_react47.useCallback)(function(_ref2) {
  ...
  var onDeactivation = (0, import_react47.useCallback)(function() {
  ...
  var returnFocus = (0, import_react47.useCallback)(function(allowDefer) {
  ...
  var onFocus3 = (0, import_react47.useCallback)(function(event) {
    if (isActive.current) {
      mediumFocus.useMedium(event);
    }
  }, []);
  var onBlur3 = mediumBlur.useMedium;
  var setObserveNode = (0, import_react47.useCallback)(function(newObserved) {
  ...
  var focusScopeValue = (0, import_react47.useMemo)(function() {
    return {
      observed,
      shards,
      enabled: !disabled,
  ...
  return import_react47.default.createElement(import_react47.Fragment, null, hasLeadingGuards && [
    ...
    hasPositiveIndices ? import_react47.default.createElement("div", {
      key: "guard-nearest",
      "data-focus-guard": true,
      tabIndex: disabled ? -1 : 1,
      style: hiddenGuard
    }) : null
  ], !disabled && import_react47.default.createElement(SideCar2, {
    id,
    ...
    focusOptions,
    noFocusGuards
  }), import_react47.default.createElement(Container3, _extends({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
    onFocus: onFocus3
  }), import_react47.default.createElement(focusScope.Provider, {
    value: focusScopeValue
  }, children)), hasTailingGuards && import_react47.default.createElement("div", {
    "data-focus-guard": true,
    tabIndex: disabled ? -1 : 0,
    style: hiddenGuard
  }));
...
// node_modules/react-focus-lock/dist/es2015/Combination.js
var FocusLockCombination = (0, import_react50.forwardRef)(function FocusLockUICombination(props, ref) {
  return import_react50.default.createElement(Lock_default, _extends({
...
var AutoFocusInside = function AutoFocusInside2(_ref2) {
  ...
  return import_react51.default.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !disabled), {
    className
  }), children);
};
...
function MoveFocusInside(_ref2) {
  ...
  return import_react52.default.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !isDisabled2), {
    ref,
    className
  }), children);
}
...
var FreeFocusInside = function FreeFocusInside2(_ref2) {
  ...
  return import_react53.default.createElement("div", _extends({}, inlineProp(FOCUS_ALLOW, true), {
    className
  }), children);
};
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react56.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react56.useCallback)(() => {
    var _a2;
...
var useSafeLayoutEffect3 = isBrowser ? import_react59.useLayoutEffect : import_react59.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-KA2477BY.mjs
var import_react60 = __toESM(require_react(), 1);
function useCallbackRef3(fn2, deps = []) {
  const ref = (0, import_react60.useRef)(fn2);
  useSafeLayoutEffect3(() => {
    ref.current = fn2;
  });
  return (0, import_react60.useCallback)((...args) => {
    var _a2;
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react62.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react67.useRef)();
...
function useOutsideClick(props) {
  ...
  const stateRef = (0, import_react68.useRef)({
    isPointerDown: false,
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react70.useRef)(null);
  const handlers2 = {
...
function useOptionalPart(partId) {
  const [id, setId] = (0, import_react71.useState)(null);
  const ref = (0, import_react71.useCallback)(
    (node2) => {
...
function useControllableState2(props) {
  ...
  const [valueState, setValue] = (0, import_react72.useState)(defaultValue);
  const isControlled = valueProp !== void 0;
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react72.useCallback)(
    (next) => {
...
function useEventListenerMap() {
  const listeners = (0, import_react74.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add = (0, import_react74.useCallback)((el, type, listener, options) => {
  ...
  const remove = (0, import_react74.useCallback)(
...
var useUpdateEffect2 = (effect5, deps) => {
  const renderCycleRef = (0, import_react75.useRef)(false);
  const effectCycleRef = (0, import_react75.useRef)(false);
...
function useFocusOnShow(target, options = defaultOptions2) {
  ...
  const autoFocusRef = (0, import_react76.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react76.useRef)(visible);
  useSafeLayoutEffect3(() => {
...
function useForceUpdate() {
  const unloadingRef = (0, import_react77.useRef)(false);
...
function useAnimationState(props) {
  ...
  const [once, setOnce] = (0, import_react78.useState)(false);
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react79.useState)(initialState2);
  const callbacks = (0, import_react79.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react80.useState)(false);
  const [valueState, setValueState] = (0, import_react80.useState)(value);
  (0, import_react80.useEffect)(() => setValueState(value), [value]);
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react82.useState)(null);
  const rafId = (0, import_react82.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node2 = ref.current;
      if (!node2)
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react84.useMemo)(
    () => shouldWrapChildren ? import_react84.Children.map(children, (child, index) => (0, import_jsx_runtime68.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const dividerStyle = (0, import_react85.useMemo)(
  ...
  const clones = (0, import_react85.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react85.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime71.jsxs)(import_react85.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime77.jsx)(import_jsx_runtime77.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime77.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime77.jsx)(import_react86.Fragment, { children: chunk.text }, index);
  }) });
}
...
var Indicator = forwardRef(function Indicator2(props, ref) {
  ...
  const styles = (0, import_react87.useMemo)(
    () => ({
      display: "inline-flex",
      justifyContent: "center",
      alignItems: "center",
...
function usePopper(props = {}) {
  ...
  const referenceRef = (0, import_react94.useCallback)(
    (node2) => {
  ...
  const getReferenceProps = (0, import_react94.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react94.useCallback)(
    (node2) => {
  ...
  const getPopperProps = (0, import_react94.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowInnerProps = (0, import_react94.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useMenu(props = {}) {
  ...
  const rafId = (0, import_react98.useRef)(null);
  return {
    openAndFocusMenu,
...
var MenuIcon = (props) => {
  ...
  const clone = (0, import_react101.isValidElement)(child) ? (0, import_react101.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react103.useState)(0);
...
function useModal(props) {
  ...
  const dialogRef = (0, import_react104.useRef)(null);
  ...
  const mouseDownTarget = (0, import_react104.useRef)(null);
  const onMouseDown = (0, import_react104.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react104.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react104.useState)(false);
  const getDialogProps = (0, import_react104.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react104.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react104.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react114.cloneElement)(child, { __css: styles })
  );
...
function PopoverTrigger(props) {
  ...
  return (0, import_react115.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function PopoverAnchor(props) {
  ...
  return (0, import_react117.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const focus2 = (0, import_react118.useCallback)(() => {
...
var SelectIcon = (props) => {
  ...
  return (0, import_jsx_runtime132.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react121.isValidElement)(children) ? clone : null });
};
...
var SkipNavLink = forwardRef(
  function SkipNavLink2(props, ref) {
    ...
    return (0, import_jsx_runtime136.jsx)(chakra.a, { ...rest, ref, href: `#${id}`, __css: getStyles2(styles) });
  }
);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react126.useLayoutEffect : import_react126.useEffect;
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react126.useState)([]);
  const [count, setCount] = (0, import_react126.useState)(0);
...
function useRangeSlider(props) {
  ...
  const [activeIndex, setActiveIndex] = (0, import_react127.useState)(-1);
  const isInteractive = !(isDisabled2 || isReadOnly);
  const initialValue = (0, import_react127.useRef)(valueState);
  ...
  const getOutputProps = (0, import_react127.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react128.useMemo)(
...
function useSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react129.useState)(false);
  const [isFocused, setFocused] = (0, import_react129.useState)(false);
  const isInteractive = !(isDisabled2 || isReadOnly);
  const tenSteps = (max2 - min2) / 10;
  const oneStep = step || (max2 - min2) / 100;
  ...
  const trackRef = (0, import_react129.useRef)(null);
  const thumbRef = (0, import_react129.useRef)(null);
  ...
  const getValueFromPointer = (0, import_react129.useCallback)(
    (event) => {
      var _a22, _b;
      if (!trackRef.current)
        return;
  ...
  const constrain = (0, import_react129.useCallback)(
    (value2) => {
      const state2 = stateRef.current;
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react129.useMemo)(() => {
    const state2 = stateRef.current;
  ...
  const focusThumb = (0, import_react129.useCallback)(() => {
    const state2 = stateRef.current;
  ...
  const getTrackProps = (0, import_react129.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref: mergeRefs(ref, trackRef),
  ...
  const getInnerTrackProps = (0, import_react129.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react129.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getMarkerProps = (0, import_react129.useCallback)(
    (props2, ref = null) => {
  ...
  const getInputProps = (0, import_react129.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
...
var Stepper = forwardRef(function Stepper2(props, ref) {
  ...
  return (0, import_jsx_runtime147.jsx)(
    chakra.div,
    {
      ...
      children: (0, import_jsx_runtime147.jsx)(StepperStylesProvider, { value: styles, children: stepElements.map((child, index2) => (0, import_jsx_runtime147.jsx)(
        StepContextProvider,
        {
          value: {
            index: index2,
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react133.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react135.useRef)();
  ...
  const exitTimeout = (0, import_react135.useRef)();
